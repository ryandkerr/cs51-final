...
$pyjs['loaded_modules']['pyjamas.DOM'] = function (__mod_name__) {
	...
	$m['eventGetKeyCode'] = function(evt) {
		var $or5,$or7,$or6;
		return ($p['bool']($or5=$p['getattr'](evt, 'which'))?$or5:($p['bool']($or6=$p['getattr'](evt, 'keyCode'))?$or6:0));
	};
	...
	$m['getChild'] = function(elem, index) {
		...
		while ($p['bool'](child)) {
			...
			if ($p['bool']($p['op_eq']($p['getattr'](child, 'nodeType'), 1))) {
	...
	$m['getFirstChild'] = function(elem) {
		...
		while ($p['bool'](($p['bool']($and13=child)?!$p['op_eq']($p['getattr'](child, 'nodeType'), 1):$and13))) {
			child = $p['getattr'](child, 'nextSibling');
		}
		return child;
	};
	...
	$m['getLastChild'] = function(elem) {
		...
		while ($p['bool'](($p['bool']($and17=child)?!$p['op_eq']($p['getattr'](child, 'nodeType'), 1):$and17))) {
	...
	$m['getPrevSibling'] = function(elem) {
		...
		while ($p['bool'](($p['bool']($and23=sib)?!$p['op_eq']($p['getattr'](sib, 'nodeType'), 1):$and23))) {
	...
	$m['getNextSibling'] = function(elem) {
		...
		while ($p['bool'](($p['bool']($and25=sib)?!$p['op_eq']($p['getattr'](sib, 'nodeType'), 1):$and25))) {
	...
	$m['scrollIntoView'] = function(elem) {
		...
		while ($p['bool'](($p['bool']($and29=cur)?$p['op_eq']($p['getattr'](cur, 'nodeType'), 1):$and29))) {
	...
	$m['sinkEvents'] = function(element, bits) {
		...
		while ($p['bool'](bits)) {
			...
			if ($p['bool']((bits)&(bit))) {
				$iter3_iter = $p['getattr']($m['Event'], 'eventbits')['__getitem__'](bit)['__getitem__'](1);
